...
import 'package:n_learn/widgets/button/app_elevated_button.dart';
...
Widget customAppElevatedButtonUseCase(BuildContext context) {
  return AppElevatedButton(
    ...
    height: context.knobs.number(label: 'height', initialValue: 0),
    size: context.knobs.options<Size>(
      label: 'Size',
      options: [
        const Option<Size>(label: 'Extra Small', value: ButtonSize.xs),
        const Option<Size>(label: 'Small', value: ButtonSize.sm),
        const Option<Size>(label: 'Medium', value: ButtonSize.md),
        const Option<Size>(label: 'Large', value: ButtonSize.lg),
      ],
    ),
